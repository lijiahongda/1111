<template>
  <div :style="{'background':'#'+bgColor}">
    ...
    <div v-for="(item,index) in list" :key="index">
      ...
      <!--模版1-->
      <div class="activety_list activety_list1" v-if="item.teamType == 1">
        <div
          class="activety_item"
      ...
      <!--模版二-->
      <div class="activety_list activety_list2" v-if="item.teamType == 2">
        <div
          class="activety_item"
          v-for="(jx,index) in item.goodsInfo"
          :key="index"
      ...
      <!--模版三-->
      <div class="activety_list activety_list3" v-if="item.teamType == 3">
        <div
          class="activety_item"
          v-for="(jx,index) in item.goodsInfo"
          :key="index"
      ...
      <div class="activity_box">
        <div
          ...
          @click="godetail(jx)"
        >
          <div class="activety_item" v-for="(jx,index) in item.goodsInfo" :key="index">
            <img :src="jx.goods_img" />
            <h1>{{jx.product_name}}</h1>
            <p>
              <em>¥</em>
...
export default {
  ...
  methods: {
    ...
    godetail(item) {
      ...
      this.$router.push({
        path: "/goodsDetailZY",
        query: { goodsId: item.product_id, skuid: item.sku_id },
      });
    },
  },
};
